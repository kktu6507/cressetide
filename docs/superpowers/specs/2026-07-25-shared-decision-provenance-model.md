...
恢復能力  **目前沒有任何已授權的 transaction 能改寫或修復這個欄位。**
         ...
         **只有** provenanceVersion 與每個 DP 的 explicit reopenCauseRef: null,
         ...
         migration／retirement／rebuild policy；**本 draft 不順手定義它**,
         也**不**授權任何實作先行。
