...
- 姊妹 spec：`2026-07-25-test-provenance-spec.md`（**draft v1.4 — 待 panel**；前一放行版本 approved v1.0）。§8 的 provenance store 與 store script 是兩者共用的 shared infrastructure，test-provenance spec 消費、不重定義。
