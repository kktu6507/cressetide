...
**Current implementation status（status carrier，非 normative；截至 2026-08-14）** —— 上表六項前置條件的現況：**六項 rollout 前置條件已有五項實作並接受，只剩 producer。五項完成**仍不放寬**「六項全部滿足才可接受 populated inventory」的規則。**
