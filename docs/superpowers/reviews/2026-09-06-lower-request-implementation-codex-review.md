# Lower direct request boundaries: independent implementation review

Decision: **ACCEPT the bounded direct API correction** in head-view-snapshot, adapter-discovery-preimage, adapter-content-view, node-test-adapter, exact-tree-blob and s3-source-freshness. Effective shared1.15 + intent1.10 + TP1.19 remain unchanged. This accepts no D draft, prospective authority helper, controller, caller integration or readiness claim.

Real local Claude Code implemented the source/tests using claude-opus-5 and xhigh after the q2/q3 reasons and bounded releases. Codex independently reviewed the final source/test changes. See the separate lower-request-capture design dialogue for the actual disagreements, two q3 fixture defects, correction and scoped reversal evidence. Implementer completion alone was not acceptance.

The four asynchronous lower operations keep the captured source root, base identity and evaluator throughout their work. Stable-head evaluation preserves the original request receiver with Reflect.apply, and returns or throws the evaluator's original result/error. Complete own-key checks accept permitted nonenumerable properties and refuse hidden/Symbol extras. The base capture already read its values once and needed only the key guard. The last four direct APIs had synchronous repeat reads: their divergent values require accessors; they are not equated with the ordinary mutable-request failures across awaits. analyzeView now uses the array reference it validated, retaining the existing pre-await copy and branded view.

The two new head tests were repaired before this decision: the evaluator only signals, awaits and returns, while an external caller changes repository A and the request. Both repositories have equal initial head views; the carrier case also starts with identical tracked configuration and preserves A's digest while untracking A alone. Old repeated root use falsely accepted both corrected premises. The module-list discriminator demonstrated analysis of two.test.mjs after validating one.test.mjs under its scoped reversal. Final head source is byte-identical to the approved q3 correction. No prototype ban, hostile-Proxy guarantee, deep clone or domain ordering change is claimed.

## Fixed-candidate evidence

HEAD 7f1b3467a0a67e625f72cfd86bbaf1fe431944f8; full checks completed 2026-09-06T07:58:11.080Z. Full regression, structure validation and deterministic eval passed with actual exits0 in the clean checkout. Every runner checked the manifest before/after; all manifests match each other and original project bytes at this decision.
...
- ℹ skipped 12
- ℹ todo 0
- ℹ duration_ms 146530.0922

| Plan | Subplans | Rows/cases |
|---|---:|---:|
| lower source identity | 3 | 22 rows |
| remaining direct entries | 1 | 17 rows |
| public request capture | 5 | 28 rows |
| preview | 3 | 25 rows |
| writer | 6 | 109 cases |
...
The22 lower rows cover actual two-repository false stability, discovery source/base identity, configuration tracking with unchanged head digest, evaluator replacement/receiver compatibility and complete own-key boundaries. The17 remaining rows cover four direct APIs and the actual validated-list/used-list discriminator. Getter counts show capture behavior; actual Git/view controls establish the semantic failure, and the two are not interchangeable. The protected consumer evidence includes46 E1 observations within those workflows. Synthetic reviewer inputs are mechanical fixtures, not an actual external reviewer invocation. Windows evidence does not establish Linux execution.

Receipts: lower-candidate-verification.json and lower-candidate-lower-request-probes.json, lower-candidate-remaining-request-probes.json, lower-candidate-request-capture-probes.json, lower-candidate-preview-probes.json, lower-writer-candidate-probes.json, lower-consumer-candidate-probes.json, lower-integration-candidate-integration-probes.json, lower-e1-candidate-e1-probes.json under .ctide/collaboration. This review is created after verification and is not included in its own manifest. The independently unapproved D draft in the candidate is present for document consistency checks only; its presence does not approve its normative content.
...
| cressetide/skills/vigil/scripts/adapter-content-view.mjs | 9a6eb0775522b4d64a7c52adf786902fe60c1b6a40d8fcbae60303ec389baed6 |
| cressetide/skills/vigil/scripts/adapter-discovery-preimage.mjs | 1abd15ff10709c066f43c1637106a69aed6295ff30f7495a0bfeb4ca305587c8 |
...
| cressetide/skills/vigil/scripts/exact-tree-blob.mjs | 5231eac51aded353a7bc282977d8ff2d595d21fbff93d2a44ebf7983f119db8a |
...
| cressetide/skills/vigil/scripts/head-view-snapshot.mjs | 88792cac35fb75401b3f29d1cc33eae119bb80d3e246f6daf920ee1b7aff9893 |
...
| cressetide/skills/vigil/scripts/node-test-adapter.mjs | 8f4f98b7d374758dcfdee9779220e80dcc833f864062eea3fb2893621a484e2b |
...
| cressetide/skills/vigil/scripts/s3-source-freshness.mjs | 09a4a40dd7050291c11e94d1733489ec6a19d868f14292a87300d83d2de0e4b6 |
...
| docs/superpowers/reviews/2026-09-06-loop-ledger-design-dialogue.md | 84be9ca525ea748391b7a901121ed306c0dfb97814f5d274cf641929b651dbb0 |
| docs/superpowers/reviews/2026-09-06-lower-request-capture-design-dialogue.md | 820932d7b74f6020ab855b2bd19b7e04aaedd3376b2bb351fe18032970a8897a |
...
| docs/superpowers/reviews/2026-09-06-request-capture-implementation-codex-review.md | 9a633888ca321990ce3c48a564347ae7e396575218e37ac9df652676e298372a |
...
| docs/superpowers/specs/2026-09-06-test-provenance-loop-amendment.md | 0496616dca9f5f049aefb569d20cd4c71296598d9fe833400c382e6942a221b0 |
...
| test/adapter-content-view.test.mjs | 71314243c9a8b6103dc4f86ee8b6f89f1b7fb364e6e20aa46629ce90ad8ab13f |
| test/adapter-discovery-preimage.test.mjs | 1a5ec2a4a2cc30a6c0854c83faf27e51bc5426d57bf3bba2284b36ef3d80d621 |
...
| test/exact-tree-blob.test.mjs | be7de56bbe268e0c0d1ca08f501bb6476805bbbc83cdaf9ffec404861e26fa5c |
| test/governance-seed-preimage.test.mjs | 5a999cef64414c61c88fac222f1ca574ac7b72335e06ba7614c922442ea6c9de |
| test/head-view-snapshot.test.mjs | 56a19886c1d91839371d425b9131d8661b030d50ffc7c61b3c1c0a94fe646097 |
| test/inventory-telemetry-observer.test.mjs | 272e9dc1f4937f552b497e6c8307dcce427467d89d22e84b86861ca341b9f657 |
| test/node-test-adapter.test.mjs | 1ac12ad6fdfc5e617d685a0ed5debcd24850b9ad373164afb4dd182efb998a43 |
...
| test/s3-source-freshness.test.mjs | 133d0f8f980f31a42f7ecf5c4e426e12abc693edfc679c79a128b517c1f99b0a |
